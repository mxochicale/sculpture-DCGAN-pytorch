...
path_to_dataset = "$/HOME/datasets/Thingi10K/05_raw_meshes/" # path to your raw_meshes folder
...
def render_in_3d(array):
	...
	mlab.points3d(xx, yy, zz, mode="cube", color=(0.96, 0.96, 0.96), scale_factor=1)
	#mlab.show()
